...
WINRT_EXPORT namespace winrt::impl
{
    template <typename D> auto consume_Windows_ApplicationModel_Calls_Provider_IPhoneCallOrigin<D>::Category() const
    {
        ...
        consume_general<winrt::Windows::ApplicationModel::Calls::Provider::IPhoneCallOrigin, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Calls::Provider::IPhoneCallOrigin>::get_Category, &winrt_impl_result);
    ...
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::ApplicationModel::Calls::Provider::IPhoneCallOrigin, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Calls::Provider::IPhoneCallOrigin>::get_CategoryDescription, &winrt_impl_result);
        return hstring{ winrt_impl_result, take_ownership_from_abi };
    }
    ...
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::ApplicationModel::Calls::Provider::IPhoneCallOrigin, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Calls::Provider::IPhoneCallOrigin>::get_Location, &winrt_impl_result);
        return hstring{ winrt_impl_result, take_ownership_from_abi };
    }
    ...
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::ApplicationModel::Calls::Provider::IPhoneCallOrigin2, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Calls::Provider::IPhoneCallOrigin2>::get_DisplayName, &winrt_impl_result);
        return hstring{ winrt_impl_result, take_ownership_from_abi };
    }
    ...
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::ApplicationModel::Calls::Provider::IPhoneCallOrigin3, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Calls::Provider::IPhoneCallOrigin3>::get_DisplayPicture, &winrt_impl_result);
    ...
    template <typename D> auto consume_Windows_ApplicationModel_Calls_Provider_IPhoneCallOriginManagerStatics<D>::IsCurrentAppActiveCallOriginApp() const
    {
        ...
        consume_general<winrt::Windows::ApplicationModel::Calls::Provider::IPhoneCallOriginManagerStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Calls::Provider::IPhoneCallOriginManagerStatics>::get_IsCurrentAppActiveCallOriginApp, &winrt_impl_result);
    ...
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::ApplicationModel::Calls::Provider::IPhoneCallOriginManagerStatics2, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Calls::Provider::IPhoneCallOriginManagerStatics2>::RequestSetAsActiveCallOriginAppAsync, &winrt_impl_result);
    ...
    {
        bool winrt_impl_result{};
        consume_general<winrt::Windows::ApplicationModel::Calls::Provider::IPhoneCallOriginManagerStatics3, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Calls::Provider::IPhoneCallOriginManagerStatics3>::get_IsSupported, &winrt_impl_result);
        return winrt_impl_result;
    }
    ...
    struct produce<D, winrt::Windows::ApplicationModel::Calls::Provider::IPhoneCallOrigin> : produce_base<D, winrt::Windows::ApplicationModel::Calls::Provider::IPhoneCallOrigin>
    {
        ...
        std::int32_t __stdcall get_CategoryDescription(void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<hstring>(this->shim().CategoryDescription());
            return 0;
        }
        catch (...) { return to_hresult(); }
    ...
    {
        std::int32_t __stdcall get_DisplayPicture(void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::Storage::StorageFile>(this->shim().DisplayPicture());
            return 0;
        }
        catch (...) { return to_hresult(); }
    ...
    {
        std::int32_t __stdcall get_IsCurrentAppActiveCallOriginApp(bool* winrt_impl_result) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<bool>(this->shim().IsCurrentAppActiveCallOriginApp());
            return 0;
        }
        catch (...) { return to_hresult(); }
    ...
    {
        std::int32_t __stdcall RequestSetAsActiveCallOriginAppAsync(void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::Foundation::IAsyncOperation<bool>>(this->shim().RequestSetAsActiveCallOriginAppAsync());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
