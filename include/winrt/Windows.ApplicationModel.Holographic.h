...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        consume_general<winrt::Windows::ApplicationModel::Holographic::IHolographicKeyboard, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Holographic::IHolographicKeyboard>::SetPlacementOverride, *(void**)(&coordinateSystem), impl::bind_in(topCenterPosition), impl::bind_in(orientation));
    }
    ...
    {
        consume_general<winrt::Windows::ApplicationModel::Holographic::IHolographicKeyboard, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Holographic::IHolographicKeyboard>::SetPlacementOverrideWithMaxSize, *(void**)(&coordinateSystem), impl::bind_in(topCenterPosition), impl::bind_in(orientation), impl::bind_in(maxSize));
    }
    ...
    {
        consume_general<winrt::Windows::ApplicationModel::Holographic::IHolographicKeyboard, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Holographic::IHolographicKeyboard>::ResetPlacementOverride);
    }
    template <typename D> auto consume_Windows_ApplicationModel_Holographic_IHolographicKeyboardStatics<D>::GetDefault() const
    {
        ...
        consume_general<winrt::Windows::ApplicationModel::Holographic::IHolographicKeyboardStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Holographic::IHolographicKeyboardStatics>::GetDefault, &winrt_impl_result);
        return winrt::Windows::ApplicationModel::Holographic::HolographicKeyboard{ winrt_impl_result, take_ownership_from_abi };
    }
    ...
    {
        std::int32_t __stdcall SetPlacementOverride(void* coordinateSystem, winrt::Windows::Foundation::Numerics::float3 topCenterPosition, winrt::Windows::Foundation::Numerics::quaternion orientation) noexcept final try
        {
        ...
        std::int32_t __stdcall SetPlacementOverrideWithMaxSize(void* coordinateSystem, winrt::Windows::Foundation::Numerics::float3 topCenterPosition, winrt::Windows::Foundation::Numerics::quaternion orientation, winrt::Windows::Foundation::Numerics::float2 maxSize) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
    ...
    struct produce<D, winrt::Windows::ApplicationModel::Holographic::IHolographicKeyboardStatics> : produce_base<D, winrt::Windows::ApplicationModel::Holographic::IHolographicKeyboardStatics>
    {
        std::int32_t __stdcall GetDefault(void** winrt_impl_result) noexcept final try
        {
            ...
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::ApplicationModel::Holographic::HolographicKeyboard>(this->shim().GetDefault());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
