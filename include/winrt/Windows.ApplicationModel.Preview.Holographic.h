...
WINRT_EXPORT namespace winrt::impl
{
    template <typename D> auto consume_Windows_ApplicationModel_Preview_Holographic_IHolographicApplicationPreviewStatics<D>::IsCurrentViewPresentedOnHolographicDisplay() const
    {
        ...
        consume_general<winrt::Windows::ApplicationModel::Preview::Holographic::IHolographicApplicationPreviewStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Preview::Holographic::IHolographicApplicationPreviewStatics>::IsCurrentViewPresentedOnHolographicDisplay, &winrt_impl_result);
    ...
    {
        bool winrt_impl_result{};
        consume_general<winrt::Windows::ApplicationModel::Preview::Holographic::IHolographicApplicationPreviewStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Preview::Holographic::IHolographicApplicationPreviewStatics>::IsHolographicActivation, *(void**)(&activatedEventArgs), &winrt_impl_result);
        return winrt_impl_result;
    }
    ...
    template <typename D> auto consume_Windows_ApplicationModel_Preview_Holographic_IHolographicKeyboardPlacementOverridePreviewStatics<D>::GetForCurrentView() const
    {
        ...
        consume_general<winrt::Windows::ApplicationModel::Preview::Holographic::IHolographicKeyboardPlacementOverridePreviewStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::ApplicationModel::Preview::Holographic::IHolographicKeyboardPlacementOverridePreviewStatics>::GetForCurrentView, &winrt_impl_result);
        return winrt::Windows::ApplicationModel::Preview::Holographic::HolographicKeyboardPlacementOverridePreview{ winrt_impl_result, take_ownership_from_abi };
    }
    ...
    {
        std::int32_t __stdcall IsCurrentViewPresentedOnHolographicDisplay(bool* winrt_impl_result) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<bool>(this->shim().IsCurrentViewPresentedOnHolographicDisplay());
            return 0;
        }
        catch (...) { return to_hresult(); }
        std::int32_t __stdcall IsHolographicActivation(void* activatedEventArgs, bool* winrt_impl_result) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<bool>(this->shim().IsHolographicActivation(*reinterpret_cast<winrt::Windows::ApplicationModel::Activation::IActivatedEventArgs const*>(&activatedEventArgs)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
    ...
    struct produce<D, winrt::Windows::ApplicationModel::Preview::Holographic::IHolographicKeyboardPlacementOverridePreviewStatics> : produce_base<D, winrt::Windows::ApplicationModel::Preview::Holographic::IHolographicKeyboardPlacementOverridePreviewStatics>
    {
        std::int32_t __stdcall GetForCurrentView(void** winrt_impl_result) noexcept final try
        {
            ...
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::ApplicationModel::Preview::Holographic::HolographicKeyboardPlacementOverridePreview>(this->shim().GetForCurrentView());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
