...
WINRT_EXPORT namespace winrt::impl
{
    template <typename D> auto consume_Windows_Data_Html_IHtmlUtilities<D>::ConvertToText(param::hstring const& html) const
    {
        ...
        consume_general<winrt::Windows::Data::Html::IHtmlUtilities, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Data::Html::IHtmlUtilities>::ConvertToText, *(void**)(&html), &winrt_impl_result);
    ...
    {
        std::int32_t __stdcall ConvertToText(void* html, void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<hstring>(this->shim().ConvertToText(*reinterpret_cast<hstring const*>(&html)));
            return 0;
        }
