...
WINRT_EXPORT namespace winrt::impl
{
    template <typename D> auto consume_Windows_Data_Xml_Xsl_IXsltProcessor<D>::TransformToString(winrt::Windows::Data::Xml::Dom::IXmlNode const& inputNode) const
    {
        ...
        consume_general<winrt::Windows::Data::Xml::Xsl::IXsltProcessor, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Data::Xml::Xsl::IXsltProcessor>::TransformToString, *(void**)(&inputNode), &winrt_impl_result);
    ...
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::Data::Xml::Xsl::IXsltProcessor2, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Data::Xml::Xsl::IXsltProcessor2>::TransformToDocument, *(void**)(&inputNode), &winrt_impl_result);
    ...
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::Data::Xml::Xsl::IXsltProcessorFactory, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Data::Xml::Xsl::IXsltProcessorFactory>::CreateInstance, *(void**)(&document), &winrt_impl_result);
        return winrt::Windows::Data::Xml::Xsl::XsltProcessor{ winrt_impl_result, take_ownership_from_abi };
    }
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, winrt::Windows::Data::Xml::Xsl::IXsltProcessor> : produce_base<D, winrt::Windows::Data::Xml::Xsl::IXsltProcessor>
    {
        std::int32_t __stdcall TransformToString(void* inputNode, void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<hstring>(this->shim().TransformToString(*reinterpret_cast<winrt::Windows::Data::Xml::Dom::IXmlNode const*>(&inputNode)));
            return 0;
        }
    ...
    {
        std::int32_t __stdcall TransformToDocument(void* inputNode, void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::Data::Xml::Dom::XmlDocument>(this->shim().TransformToDocument(*reinterpret_cast<winrt::Windows::Data::Xml::Dom::IXmlNode const*>(&inputNode)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
    ...
    {
        std::int32_t __stdcall CreateInstance(void* document, void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::Data::Xml::Xsl::XsltProcessor>(this->shim().CreateInstance(*reinterpret_cast<winrt::Windows::Data::Xml::Dom::XmlDocument const*>(&document)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
