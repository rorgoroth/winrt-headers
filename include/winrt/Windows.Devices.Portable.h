...
WINRT_EXPORT namespace winrt::impl
{
    template <typename D> auto consume_Windows_Devices_Portable_IServiceDeviceStatics<D>::GetDeviceSelector(winrt::Windows::Devices::Portable::ServiceDeviceType const& serviceType) const
    {
        ...
        consume_general<winrt::Windows::Devices::Portable::IServiceDeviceStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Devices::Portable::IServiceDeviceStatics>::GetDeviceSelector, static_cast<std::int32_t>(serviceType), &winrt_impl_result);
    ...
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::Devices::Portable::IServiceDeviceStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Devices::Portable::IServiceDeviceStatics>::GetDeviceSelectorFromServiceId, impl::bind_in(serviceId), &winrt_impl_result);
        return hstring{ winrt_impl_result, take_ownership_from_abi };
    }
    ...
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::Devices::Portable::IStorageDeviceStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Devices::Portable::IStorageDeviceStatics>::FromId, *(void**)(&deviceId), &winrt_impl_result);
    ...
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::Devices::Portable::IStorageDeviceStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Devices::Portable::IStorageDeviceStatics>::GetDeviceSelector, &winrt_impl_result);
        return hstring{ winrt_impl_result, take_ownership_from_abi };
    }
    ...
    {
        std::int32_t __stdcall GetDeviceSelector(std::int32_t serviceType, void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<hstring>(this->shim().GetDeviceSelector(*reinterpret_cast<winrt::Windows::Devices::Portable::ServiceDeviceType const*>(&serviceType)));
            return 0;
        }
        catch (...) { return to_hresult(); }
        std::int32_t __stdcall GetDeviceSelectorFromServiceId(winrt::guid serviceId, void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<hstring>(this->shim().GetDeviceSelectorFromServiceId(*reinterpret_cast<winrt::guid const*>(&serviceId)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
    ...
    struct produce<D, winrt::Windows::Devices::Portable::IStorageDeviceStatics> : produce_base<D, winrt::Windows::Devices::Portable::IStorageDeviceStatics>
    {
        std::int32_t __stdcall FromId(void* deviceId, void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::Storage::StorageFolder>(this->shim().FromId(*reinterpret_cast<hstring const*>(&deviceId)));
            return 0;
        }
        catch (...) { return to_hresult(); }
