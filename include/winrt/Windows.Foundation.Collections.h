...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <typename D, typename K, typename V> auto consume_Windows_Foundation_Collections_IObservableMap<D, K, V>::MapChanged(winrt::Windows::Foundation::Collections::MapChangedEventHandler<K, V> const& handler) const
    {
        winrt::event_token winrt_impl_result{};
        consume_general<winrt::Windows::Foundation::Collections::IObservableMap<K, V>, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Foundation::Collections::IObservableMap<K, V>>::add_MapChanged, *(void**)(&handler), put_abi(winrt_impl_result));
        return winrt_impl_result;
    }
    template <typename D, typename K, typename V> auto consume_Windows_Foundation_Collections_IObservableMap<D, K, V>::MapChanged(auto_revoke_t, winrt::Windows::Foundation::Collections::MapChangedEventHandler<K, V> const& handler) const
    {
        return impl::make_event_revoker<D, MapChanged_revoker>(this, MapChanged(handler));
    }
    ...
    template <typename D, typename T> auto consume_Windows_Foundation_Collections_IObservableVector<D, T>::VectorChanged(winrt::Windows::Foundation::Collections::VectorChangedEventHandler<T> const& handler) const
    {
        winrt::event_token winrt_impl_result{};
        consume_general<winrt::Windows::Foundation::Collections::IObservableVector<T>, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Foundation::Collections::IObservableVector<T>>::add_VectorChanged, *(void**)(&handler), put_abi(winrt_impl_result));
        return winrt_impl_result;
    }
    template <typename D, typename T> auto consume_Windows_Foundation_Collections_IObservableVector<D, T>::VectorChanged(auto_revoke_t, winrt::Windows::Foundation::Collections::VectorChangedEventHandler<T> const& handler) const
    {
    ...
    {
        winrt::Windows::Foundation::Collections::CollectionChange winrt_impl_result{};
        consume_general<winrt::Windows::Foundation::Collections::IVectorChangedEventArgs, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Foundation::Collections::IVectorChangedEventArgs>::get_CollectionChange, reinterpret_cast<std::int32_t*>(&winrt_impl_result));
        return winrt_impl_result;
    }
    template <typename D> auto consume_Windows_Foundation_Collections_IVectorChangedEventArgs<D>::Index() const
    {
        std::uint32_t winrt_impl_result{};
        consume_general<winrt::Windows::Foundation::Collections::IVectorChangedEventArgs, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Foundation::Collections::IVectorChangedEventArgs>::get_Index, &winrt_impl_result);
        return winrt_impl_result;
    }
    ...
    {
        std::int32_t __stdcall add_MapChanged(void* handler, winrt::event_token* winrt_impl_result) noexcept final try
        {
            zero_abi<winrt::event_token>(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::event_token>(this->shim().MapChanged(*reinterpret_cast<winrt::Windows::Foundation::Collections::MapChangedEventHandler<K, V> const*>(&handler)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    ...
    struct produce<D, winrt::Windows::Foundation::Collections::IObservableVector<T>> : produce_base<D, winrt::Windows::Foundation::Collections::IObservableVector<T>>
    {
        std::int32_t __stdcall add_VectorChanged(void* handler, winrt::event_token* winrt_impl_result) noexcept final try
        {
            zero_abi<winrt::event_token>(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::event_token>(this->shim().VectorChanged(*reinterpret_cast<winrt::Windows::Foundation::Collections::VectorChangedEventHandler<T> const*>(&handler)));
            return 0;
        }
        catch (...) { return to_hresult(); }
