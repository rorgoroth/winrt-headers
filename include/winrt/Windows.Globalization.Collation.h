...
WINRT_EXPORT namespace winrt::impl
{
    template <typename D> auto consume_Windows_Globalization_Collation_ICharacterGrouping<D>::First() const
    {
        ...
        consume_general<winrt::Windows::Globalization::Collation::ICharacterGrouping, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Globalization::Collation::ICharacterGrouping>::get_First, &winrt_impl_result);
    ...
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::Globalization::Collation::ICharacterGrouping, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Globalization::Collation::ICharacterGrouping>::get_Label, &winrt_impl_result);
        return hstring{ winrt_impl_result, take_ownership_from_abi };
    }
    ...
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::Globalization::Collation::ICharacterGroupings, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Globalization::Collation::ICharacterGroupings>::Lookup, *(void**)(&text), &winrt_impl_result);
        return hstring{ winrt_impl_result, take_ownership_from_abi };
    }
    ...
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::Globalization::Collation::ICharacterGroupingsFactory, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Globalization::Collation::ICharacterGroupingsFactory>::Create, *(void**)(&language), &winrt_impl_result);
        return winrt::Windows::Globalization::Collation::CharacterGroupings{ winrt_impl_result, take_ownership_from_abi };
    }
    ...
    {
        std::int32_t __stdcall get_First(void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<hstring>(this->shim().First());
            return 0;
        }
    ...
    {
        std::int32_t __stdcall Lookup(void* text, void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<hstring>(this->shim().Lookup(*reinterpret_cast<hstring const*>(&text)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
    ...
    struct produce<D, winrt::Windows::Globalization::Collation::ICharacterGroupingsFactory> : produce_base<D, winrt::Windows::Globalization::Collation::ICharacterGroupingsFactory>
    {
        std::int32_t __stdcall Create(void* language, void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::Globalization::Collation::CharacterGroupings>(this->shim().Create(*reinterpret_cast<hstring const*>(&language)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
