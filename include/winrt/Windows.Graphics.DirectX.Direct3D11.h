...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        winrt::Windows::Graphics::DirectX::Direct3D11::Direct3DSurfaceDescription winrt_impl_result{};
        consume_general<winrt::Windows::Graphics::DirectX::Direct3D11::IDirect3DSurface, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Graphics::DirectX::Direct3D11::IDirect3DSurface>::get_Description, put_abi(winrt_impl_result));
    ...
    {
        std::int32_t __stdcall get_Description(struct struct_Windows_Graphics_DirectX_Direct3D11_Direct3DSurfaceDescription* winrt_impl_result) noexcept final try
        {
            zero_abi<winrt::Windows::Graphics::DirectX::Direct3D11::Direct3DSurfaceDescription>(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::Graphics::DirectX::Direct3D11::Direct3DSurfaceDescription>(this->shim().Description());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
