...
WINRT_EXPORT namespace winrt::impl
{
    template <typename D> auto consume_Windows_Graphics_Printing_ProtectedPrint_IWindowsProtectedPrintInfoStatics<D>::IsProtectedPrintEnabled() const
    {
        ...
        consume_general<winrt::Windows::Graphics::Printing::ProtectedPrint::IWindowsProtectedPrintInfoStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Graphics::Printing::ProtectedPrint::IWindowsProtectedPrintInfoStatics>::get_IsProtectedPrintEnabled, &winrt_impl_result);
    ...
    {
        std::int32_t __stdcall get_IsProtectedPrintEnabled(bool* winrt_impl_result) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<bool>(this->shim().IsProtectedPrintEnabled());
            return 0;
        }
