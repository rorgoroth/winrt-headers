...
WINRT_EXPORT namespace winrt::impl
{
    template <typename D> auto consume_Windows_Management_Core_IApplicationDataManagerStatics<D>::CreateForPackageFamily(param::hstring const& packageFamilyName) const
    {
        ...
        consume_general<winrt::Windows::Management::Core::IApplicationDataManagerStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Management::Core::IApplicationDataManagerStatics>::CreateForPackageFamily, *(void**)(&packageFamilyName), &winrt_impl_result);
    ...
    {
        std::int32_t __stdcall CreateForPackageFamily(void* packageFamilyName, void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::Storage::ApplicationData>(this->shim().CreateForPackageFamily(*reinterpret_cast<hstring const*>(&packageFamilyName)));
            return 0;
        }
