...
WINRT_EXPORT namespace winrt::impl
{
    template <typename D> auto consume_Windows_Management_Deployment_Preview_IClassicAppManagerStatics<D>::FindInstalledApp(param::hstring const& appUninstallKey) const
    {
        ...
        consume_general<winrt::Windows::Management::Deployment::Preview::IClassicAppManagerStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Management::Deployment::Preview::IClassicAppManagerStatics>::FindInstalledApp, *(void**)(&appUninstallKey), &winrt_impl_result);
        return winrt::Windows::Management::Deployment::Preview::InstalledClassicAppInfo{ winrt_impl_result, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_Management_Deployment_Preview_IInstalledClassicAppInfo<D>::DisplayName() const
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::Management::Deployment::Preview::IInstalledClassicAppInfo, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Management::Deployment::Preview::IInstalledClassicAppInfo>::get_DisplayName, &winrt_impl_result);
    ...
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::Management::Deployment::Preview::IInstalledClassicAppInfo, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Management::Deployment::Preview::IInstalledClassicAppInfo>::get_DisplayVersion, &winrt_impl_result);
        return hstring{ winrt_impl_result, take_ownership_from_abi };
    }
    ...
    {
        std::int32_t __stdcall FindInstalledApp(void* appUninstallKey, void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::Management::Deployment::Preview::InstalledClassicAppInfo>(this->shim().FindInstalledApp(*reinterpret_cast<hstring const*>(&appUninstallKey)));
            return 0;
        }
