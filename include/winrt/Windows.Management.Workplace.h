...
WINRT_EXPORT namespace winrt::impl
{
    template <typename D> auto consume_Windows_Management_Workplace_IMdmAllowPolicyStatics<D>::IsBrowserAllowed() const
    {
        ...
        consume_general<winrt::Windows::Management::Workplace::IMdmAllowPolicyStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Management::Workplace::IMdmAllowPolicyStatics>::IsBrowserAllowed, &winrt_impl_result);
    ...
    {
        bool winrt_impl_result{};
        consume_general<winrt::Windows::Management::Workplace::IMdmAllowPolicyStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Management::Workplace::IMdmAllowPolicyStatics>::IsCameraAllowed, &winrt_impl_result);
        return winrt_impl_result;
    }
    template <typename D> auto consume_Windows_Management_Workplace_IMdmAllowPolicyStatics<D>::IsMicrosoftAccountAllowed() const
    {
        bool winrt_impl_result{};
        consume_general<winrt::Windows::Management::Workplace::IMdmAllowPolicyStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Management::Workplace::IMdmAllowPolicyStatics>::IsMicrosoftAccountAllowed, &winrt_impl_result);
        return winrt_impl_result;
    }
    template <typename D> auto consume_Windows_Management_Workplace_IMdmAllowPolicyStatics<D>::IsStoreAllowed() const
    {
        bool winrt_impl_result{};
        consume_general<winrt::Windows::Management::Workplace::IMdmAllowPolicyStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Management::Workplace::IMdmAllowPolicyStatics>::IsStoreAllowed, &winrt_impl_result);
        return winrt_impl_result;
    }
    template <typename D> auto consume_Windows_Management_Workplace_IMdmPolicyStatics2<D>::GetMessagingSyncPolicy() const
    {
        winrt::Windows::Management::Workplace::MessagingSyncPolicy winrt_impl_result{};
        consume_general<winrt::Windows::Management::Workplace::IMdmPolicyStatics2, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Management::Workplace::IMdmPolicyStatics2>::GetMessagingSyncPolicy, reinterpret_cast<std::int32_t*>(&winrt_impl_result));
        return winrt_impl_result;
    }
    ...
    {
        bool winrt_impl_result{};
        consume_general<winrt::Windows::Management::Workplace::IWorkplaceSettingsStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Management::Workplace::IWorkplaceSettingsStatics>::get_IsMicrosoftAccountOptional, &winrt_impl_result);
        return winrt_impl_result;
    }
    ...
    {
        std::int32_t __stdcall IsBrowserAllowed(bool* winrt_impl_result) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<bool>(this->shim().IsBrowserAllowed());
            return 0;
        }
        catch (...) { return to_hresult(); }
        std::int32_t __stdcall IsCameraAllowed(bool* winrt_impl_result) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<bool>(this->shim().IsCameraAllowed());
            return 0;
        }
        catch (...) { return to_hresult(); }
        std::int32_t __stdcall IsMicrosoftAccountAllowed(bool* winrt_impl_result) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<bool>(this->shim().IsMicrosoftAccountAllowed());
            return 0;
        }
        catch (...) { return to_hresult(); }
        std::int32_t __stdcall IsStoreAllowed(bool* winrt_impl_result) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<bool>(this->shim().IsStoreAllowed());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
    ...
    {
        std::int32_t __stdcall GetMessagingSyncPolicy(std::int32_t* winrt_impl_result) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::Management::Workplace::MessagingSyncPolicy>(this->shim().GetMessagingSyncPolicy());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
    ...
    {
        std::int32_t __stdcall get_IsMicrosoftAccountOptional(bool* winrt_impl_result) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<bool>(this->shim().IsMicrosoftAccountOptional());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
