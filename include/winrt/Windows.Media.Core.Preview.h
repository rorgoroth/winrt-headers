...
WINRT_EXPORT namespace winrt::impl
{
    template <typename D> auto consume_Windows_Media_Core_Preview_ISoundLevelBrokerStatics<D>::SoundLevel() const
    {
        ...
        consume_general<winrt::Windows::Media::Core::Preview::ISoundLevelBrokerStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Media::Core::Preview::ISoundLevelBrokerStatics>::get_SoundLevel, reinterpret_cast<std::int32_t*>(&winrt_impl_result));
    ...
    template <typename D> auto consume_Windows_Media_Core_Preview_ISoundLevelBrokerStatics<D>::SoundLevelChanged(winrt::Windows::Foundation::EventHandler<winrt::Windows::Foundation::IInspectable> const& handler) const
    {
        ...
        consume_general<winrt::Windows::Media::Core::Preview::ISoundLevelBrokerStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Media::Core::Preview::ISoundLevelBrokerStatics>::add_SoundLevelChanged, *(void**)(&handler), put_abi(winrt_impl_result));
        return winrt_impl_result;
    }
