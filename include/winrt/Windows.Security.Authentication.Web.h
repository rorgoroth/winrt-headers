...
WINRT_EXPORT namespace winrt::impl
{
    template <typename D> auto consume_Windows_Security_Authentication_Web_IWebAuthenticationBrokerStatics<D>::AuthenticateAsync(winrt::Windows::Security::Authentication::Web::WebAuthenticationOptions const& options, winrt::Windows::Foundation::Uri const& requestUri, winrt::Windows::Foundation::Uri const& callbackUri) const
    {
        ...
        consume_general<winrt::Windows::Security::Authentication::Web::IWebAuthenticationBrokerStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Security::Authentication::Web::IWebAuthenticationBrokerStatics>::AuthenticateWithCallbackUriAsync, static_cast<std::uint32_t>(options), *(void**)(&requestUri), *(void**)(&callbackUri), &winrt_impl_result);
        return winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Security::Authentication::Web::WebAuthenticationResult>{ winrt_impl_result, take_ownership_from_abi };
    }
    ...
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::Security::Authentication::Web::IWebAuthenticationBrokerStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Security::Authentication::Web::IWebAuthenticationBrokerStatics>::AuthenticateWithoutCallbackUriAsync, static_cast<std::uint32_t>(options), *(void**)(&requestUri), &winrt_impl_result);
        return winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Security::Authentication::Web::WebAuthenticationResult>{ winrt_impl_result, take_ownership_from_abi };
    }
    ...
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::Security::Authentication::Web::IWebAuthenticationBrokerStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Security::Authentication::Web::IWebAuthenticationBrokerStatics>::GetCurrentApplicationCallbackUri, &winrt_impl_result);
    ...
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::Security::Authentication::Web::IWebAuthenticationBrokerStatics2, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Security::Authentication::Web::IWebAuthenticationBrokerStatics2>::AuthenticateSilentlyAsync, *(void**)(&requestUri), &winrt_impl_result);
        return winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Security::Authentication::Web::WebAuthenticationResult>{ winrt_impl_result, take_ownership_from_abi };
    }
    ...
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::Security::Authentication::Web::IWebAuthenticationBrokerStatics2, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Security::Authentication::Web::IWebAuthenticationBrokerStatics2>::AuthenticateSilentlyWithOptionsAsync, *(void**)(&requestUri), static_cast<std::uint32_t>(options), &winrt_impl_result);
        return winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Security::Authentication::Web::WebAuthenticationResult>{ winrt_impl_result, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_Security_Authentication_Web_IWebAuthenticationResult<D>::ResponseData() const
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::Security::Authentication::Web::IWebAuthenticationResult, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Security::Authentication::Web::IWebAuthenticationResult>::get_ResponseData, &winrt_impl_result);
    ...
    {
        winrt::Windows::Security::Authentication::Web::WebAuthenticationStatus winrt_impl_result{};
        consume_general<winrt::Windows::Security::Authentication::Web::IWebAuthenticationResult, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Security::Authentication::Web::IWebAuthenticationResult>::get_ResponseStatus, reinterpret_cast<std::int32_t*>(&winrt_impl_result));
    ...
    template <typename D> auto consume_Windows_Security_Authentication_Web_IWebAuthenticationResult<D>::ResponseErrorDetail() const
    {
        ...
        consume_general<winrt::Windows::Security::Authentication::Web::IWebAuthenticationResult, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::Security::Authentication::Web::IWebAuthenticationResult>::get_ResponseErrorDetail, &winrt_impl_result);
        return winrt_impl_result;
    }
    ...
    {
        std::int32_t __stdcall AuthenticateWithCallbackUriAsync(std::uint32_t options, void* requestUri, void* callbackUri, void** winrt_impl_result) noexcept final try
        {
        ...
        std::int32_t __stdcall AuthenticateWithoutCallbackUriAsync(std::uint32_t options, void* requestUri, void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall GetCurrentApplicationCallbackUri(void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::Foundation::Uri>(this->shim().GetCurrentApplicationCallbackUri());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
    ...
    struct produce<D, winrt::Windows::Security::Authentication::Web::IWebAuthenticationBrokerStatics2> : produce_base<D, winrt::Windows::Security::Authentication::Web::IWebAuthenticationBrokerStatics2>
    {
        ...
        std::int32_t __stdcall AuthenticateSilentlyAsync(void* requestUri, void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Security::Authentication::Web::WebAuthenticationResult>>(this->shim().AuthenticateSilentlyAsync(*reinterpret_cast<winrt::Windows::Foundation::Uri const*>(&requestUri)));
            return 0;
        }
        catch (...) { return to_hresult(); }
        std::int32_t __stdcall AuthenticateSilentlyWithOptionsAsync(void* requestUri, std::uint32_t options, void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
    ...
    struct produce<D, winrt::Windows::Security::Authentication::Web::IWebAuthenticationResult> : produce_base<D, winrt::Windows::Security::Authentication::Web::IWebAuthenticationResult>
    {
        std::int32_t __stdcall get_ResponseData(void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<hstring>(this->shim().ResponseData());
            return 0;
        }
        catch (...) { return to_hresult(); }
        ...
        {
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::Security::Authentication::Web::WebAuthenticationStatus>(this->shim().ResponseStatus());
            return 0;
        }
        catch (...) { return to_hresult(); }
        std::int32_t __stdcall get_ResponseErrorDetail(std::uint32_t* winrt_impl_result) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<std::uint32_t>(this->shim().ResponseErrorDetail());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
