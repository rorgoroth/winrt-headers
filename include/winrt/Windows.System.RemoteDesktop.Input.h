...
WINRT_EXPORT namespace winrt::impl
{
    template <typename D> auto consume_Windows_System_RemoteDesktop_Input_IRemoteTextConnection<D>::IsEnabled() const
    {
        ...
        consume_general<winrt::Windows::System::RemoteDesktop::Input::IRemoteTextConnection, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::RemoteDesktop::Input::IRemoteTextConnection>::get_IsEnabled, &winrt_impl_result);
    ...
    {
        consume_general<winrt::Windows::System::RemoteDesktop::Input::IRemoteTextConnection, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::RemoteDesktop::Input::IRemoteTextConnection>::put_IsEnabled, value);
    }
    template <typename D> auto consume_Windows_System_RemoteDesktop_Input_IRemoteTextConnection<D>::RegisterThread(std::uint32_t threadId) const
    {
        consume_general<winrt::Windows::System::RemoteDesktop::Input::IRemoteTextConnection, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::RemoteDesktop::Input::IRemoteTextConnection>::RegisterThread, threadId);
    }
    template <typename D> auto consume_Windows_System_RemoteDesktop_Input_IRemoteTextConnection<D>::UnregisterThread(std::uint32_t threadId) const
    {
        consume_general<winrt::Windows::System::RemoteDesktop::Input::IRemoteTextConnection, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::RemoteDesktop::Input::IRemoteTextConnection>::UnregisterThread, threadId);
    }
    template <typename D> auto consume_Windows_System_RemoteDesktop_Input_IRemoteTextConnection<D>::ReportDataReceived(array_view<std::uint8_t const> pduData) const
    {
        consume_general<winrt::Windows::System::RemoteDesktop::Input::IRemoteTextConnection, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::RemoteDesktop::Input::IRemoteTextConnection>::ReportDataReceived, pduData.size(), get_abi(pduData));
    }
    template <typename D> auto consume_Windows_System_RemoteDesktop_Input_IRemoteTextConnection2<D>::ReportPredictedKeyEvent(std::uint16_t scanCode, winrt::Windows::System::RemoteDesktop::Input::RemoteKeyEventAttributes const& attributes) const
    {
        consume_general<winrt::Windows::System::RemoteDesktop::Input::IRemoteTextConnection2, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::RemoteDesktop::Input::IRemoteTextConnection2>::ReportPredictedKeyEvent, scanCode, static_cast<std::uint32_t>(attributes));
    }
    template <typename D> auto consume_Windows_System_RemoteDesktop_Input_IRemoteTextConnectionFactory<D>::CreateInstance(winrt::guid const& connectionId, winrt::Windows::System::RemoteDesktop::Input::RemoteTextConnectionDataHandler const& pduForwarder) const
    {
        ...
        consume_general<winrt::Windows::System::RemoteDesktop::Input::IRemoteTextConnectionFactory, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::RemoteDesktop::Input::IRemoteTextConnectionFactory>::CreateInstance, impl::bind_in(connectionId), *(void**)(&pduForwarder), &winrt_impl_result);
        return winrt::Windows::System::RemoteDesktop::Input::RemoteTextConnection{ winrt_impl_result, take_ownership_from_abi };
    }
    ...
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::System::RemoteDesktop::Input::IRemoteTextConnectionFactory2, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::RemoteDesktop::Input::IRemoteTextConnectionFactory2>::CreateInstance, impl::bind_in(connectionId), *(void**)(&pduForwarder), static_cast<std::uint32_t>(options), &winrt_impl_result);
        return winrt::Windows::System::RemoteDesktop::Input::RemoteTextConnection{ winrt_impl_result, take_ownership_from_abi };
    }
    template <typename H> struct delegate<winrt::Windows::System::RemoteDesktop::Input::RemoteTextConnectionDataHandler, H> final : implements_delegate<winrt::Windows::System::RemoteDesktop::Input::RemoteTextConnectionDataHandler, H>
    {
        ...
        std::int32_t __stdcall Invoke(std::uint32_t __pduDataSize, std::uint8_t* pduData, bool* winrt_impl_result) noexcept final try
        {
            *winrt_impl_result = detach_from<bool>((*this)(array_view<std::uint8_t const>(reinterpret_cast<std::uint8_t const *>(pduData), reinterpret_cast<std::uint8_t const *>(pduData) + __pduDataSize)));
            return 0;
        }
    ...
    struct produce<D, winrt::Windows::System::RemoteDesktop::Input::IRemoteTextConnection> : produce_base<D, winrt::Windows::System::RemoteDesktop::Input::IRemoteTextConnection>
    {
        ...
        std::int32_t __stdcall RegisterThread(std::uint32_t threadId) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall UnregisterThread(std::uint32_t threadId) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall ReportDataReceived(std::uint32_t __pduDataSize, std::uint8_t* pduData) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            this->shim().ReportDataReceived(array_view<std::uint8_t const>(reinterpret_cast<std::uint8_t const *>(pduData), reinterpret_cast<std::uint8_t const *>(pduData) + __pduDataSize));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
    ...
    {
        std::int32_t __stdcall ReportPredictedKeyEvent(std::uint16_t scanCode, std::uint32_t attributes) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
    ...
    {
        std::int32_t __stdcall CreateInstance(winrt::guid connectionId, void* pduForwarder, void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::System::RemoteDesktop::Input::RemoteTextConnection>(this->shim().CreateInstance(*reinterpret_cast<winrt::guid const*>(&connectionId), *reinterpret_cast<winrt::Windows::System::RemoteDesktop::Input::RemoteTextConnectionDataHandler const*>(&pduForwarder)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
    ...
    {
        std::int32_t __stdcall CreateInstance(winrt::guid connectionId, void* pduForwarder, std::uint32_t options, void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::System::RemoteDesktop::Input::RemoteTextConnection>(this->shim().CreateInstance(*reinterpret_cast<winrt::guid const*>(&connectionId), *reinterpret_cast<winrt::Windows::System::RemoteDesktop::Input::RemoteTextConnectionDataHandler const*>(&pduForwarder), *reinterpret_cast<winrt::Windows::System::RemoteDesktop::Input::RemoteTextConnectionOptions const*>(&options)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
...
WINRT_EXPORT namespace winrt::Windows::System::RemoteDesktop::Input
{
    ...
    inline auto RemoteTextConnectionDataHandler::operator()(array_view<std::uint8_t const> pduData) const
    {
        bool winrt_impl_result{};
        check_hresult((*(impl::abi_t<RemoteTextConnectionDataHandler>**)this)->Invoke(pduData.size(), get_abi(pduData), &winrt_impl_result));
        return winrt_impl_result;
    }
}
namespace std
