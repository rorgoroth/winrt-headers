...
WINRT_EXPORT namespace winrt::impl
{
    template <typename D> auto consume_Windows_System_RemoteDesktop_IInteractiveSessionStatics<D>::IsRemote() const
    {
        ...
        consume_general<winrt::Windows::System::RemoteDesktop::IInteractiveSessionStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::RemoteDesktop::IInteractiveSessionStatics>::get_IsRemote, &winrt_impl_result);
    ...
    {
        std::int32_t __stdcall get_IsRemote(bool* winrt_impl_result) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<bool>(this->shim().IsRemote());
            return 0;
        }
