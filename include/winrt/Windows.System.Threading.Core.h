...
WINRT_EXPORT namespace winrt::impl
{
    template <typename D> auto consume_Windows_System_Threading_Core_IPreallocatedWorkItem<D>::RunAsync() const
    {
        ...
        consume_general<winrt::Windows::System::Threading::Core::IPreallocatedWorkItem, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::Core::IPreallocatedWorkItem>::RunAsync, &winrt_impl_result);
    ...
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::System::Threading::Core::IPreallocatedWorkItemFactory, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::Core::IPreallocatedWorkItemFactory>::CreateWorkItem, *(void**)(&handler), &winrt_impl_result);
        return winrt::Windows::System::Threading::Core::PreallocatedWorkItem{ winrt_impl_result, take_ownership_from_abi };
    }
    ...
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::System::Threading::Core::IPreallocatedWorkItemFactory, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::Core::IPreallocatedWorkItemFactory>::CreateWorkItemWithPriority, *(void**)(&handler), static_cast<std::int32_t>(priority), &winrt_impl_result);
        return winrt::Windows::System::Threading::Core::PreallocatedWorkItem{ winrt_impl_result, take_ownership_from_abi };
    }
    ...
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::System::Threading::Core::ISignalNotifierStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::Core::ISignalNotifierStatics>::AttachToEvent, *(void**)(&name), *(void**)(&handler), &winrt_impl_result);
        return winrt::Windows::System::Threading::Core::SignalNotifier{ winrt_impl_result, take_ownership_from_abi };
    }
    ...
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::System::Threading::Core::ISignalNotifierStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::Core::ISignalNotifierStatics>::AttachToEventWithTimeout, *(void**)(&name), *(void**)(&handler), impl::bind_in(timeout), &winrt_impl_result);
        return winrt::Windows::System::Threading::Core::SignalNotifier{ winrt_impl_result, take_ownership_from_abi };
    }
    ...
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::System::Threading::Core::ISignalNotifierStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::Core::ISignalNotifierStatics>::AttachToSemaphore, *(void**)(&name), *(void**)(&handler), &winrt_impl_result);
        return winrt::Windows::System::Threading::Core::SignalNotifier{ winrt_impl_result, take_ownership_from_abi };
    }
    ...
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::System::Threading::Core::ISignalNotifierStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::Core::ISignalNotifierStatics>::AttachToSemaphoreWithTimeout, *(void**)(&name), *(void**)(&handler), impl::bind_in(timeout), &winrt_impl_result);
        return winrt::Windows::System::Threading::Core::SignalNotifier{ winrt_impl_result, take_ownership_from_abi };
    }
    ...
    {
        std::int32_t __stdcall RunAsync(void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::Foundation::IAsyncAction>(this->shim().RunAsync());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
    ...
    {
        std::int32_t __stdcall CreateWorkItem(void* handler, void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::System::Threading::Core::PreallocatedWorkItem>(this->shim().CreateWorkItem(*reinterpret_cast<winrt::Windows::System::Threading::WorkItemHandler const*>(&handler)));
            return 0;
        }
        catch (...) { return to_hresult(); }
        std::int32_t __stdcall CreateWorkItemWithPriority(void* handler, std::int32_t priority, void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::System::Threading::Core::PreallocatedWorkItem>(this->shim().CreateWorkItemWithPriority(*reinterpret_cast<winrt::Windows::System::Threading::WorkItemHandler const*>(&handler), *reinterpret_cast<winrt::Windows::System::Threading::WorkItemPriority const*>(&priority)));
            return 0;
        }
        catch (...) { return to_hresult(); }
        std::int32_t __stdcall CreateWorkItemWithPriorityAndOptions(void* handler, std::int32_t priority, std::uint32_t options, void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::System::Threading::Core::PreallocatedWorkItem>(this->shim().CreateWorkItemWithPriorityAndOptions(*reinterpret_cast<winrt::Windows::System::Threading::WorkItemHandler const*>(&handler), *reinterpret_cast<winrt::Windows::System::Threading::WorkItemPriority const*>(&priority), *reinterpret_cast<winrt::Windows::System::Threading::WorkItemOptions const*>(&options)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
    ...
    {
        std::int32_t __stdcall AttachToEvent(void* name, void* handler, void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::System::Threading::Core::SignalNotifier>(this->shim().AttachToEvent(*reinterpret_cast<hstring const*>(&name), *reinterpret_cast<winrt::Windows::System::Threading::Core::SignalHandler const*>(&handler)));
            return 0;
        }
        catch (...) { return to_hresult(); }
        std::int32_t __stdcall AttachToEventWithTimeout(void* name, void* handler, std::int64_t timeout, void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::System::Threading::Core::SignalNotifier>(this->shim().AttachToEvent(*reinterpret_cast<hstring const*>(&name), *reinterpret_cast<winrt::Windows::System::Threading::Core::SignalHandler const*>(&handler), *reinterpret_cast<winrt::Windows::Foundation::TimeSpan const*>(&timeout)));
            return 0;
        }
        catch (...) { return to_hresult(); }
        std::int32_t __stdcall AttachToSemaphore(void* name, void* handler, void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::System::Threading::Core::SignalNotifier>(this->shim().AttachToSemaphore(*reinterpret_cast<hstring const*>(&name), *reinterpret_cast<winrt::Windows::System::Threading::Core::SignalHandler const*>(&handler)));
            return 0;
        }
        catch (...) { return to_hresult(); }
        std::int32_t __stdcall AttachToSemaphoreWithTimeout(void* name, void* handler, std::int64_t timeout, void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::System::Threading::Core::SignalNotifier>(this->shim().AttachToSemaphore(*reinterpret_cast<hstring const*>(&name), *reinterpret_cast<winrt::Windows::System::Threading::Core::SignalHandler const*>(&handler), *reinterpret_cast<winrt::Windows::Foundation::TimeSpan const*>(&timeout)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
