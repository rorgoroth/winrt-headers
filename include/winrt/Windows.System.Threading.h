...
WINRT_EXPORT namespace winrt::impl
{
    template <typename D> auto consume_Windows_System_Threading_IThreadPoolStatics<D>::RunAsync(winrt::Windows::System::Threading::WorkItemHandler const& handler) const
    {
        ...
        consume_general<winrt::Windows::System::Threading::IThreadPoolStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::IThreadPoolStatics>::RunAsync, *(void**)(&handler), &winrt_impl_result);
    ...
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::System::Threading::IThreadPoolStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::IThreadPoolStatics>::RunWithPriorityAsync, *(void**)(&handler), static_cast<std::int32_t>(priority), &winrt_impl_result);
        return winrt::Windows::Foundation::IAsyncAction{ winrt_impl_result, take_ownership_from_abi };
    }
    ...
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::System::Threading::IThreadPoolStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::IThreadPoolStatics>::RunWithPriorityAndOptionsAsync, *(void**)(&handler), static_cast<std::int32_t>(priority), static_cast<std::uint32_t>(options), &winrt_impl_result);
        return winrt::Windows::Foundation::IAsyncAction{ winrt_impl_result, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_System_Threading_IThreadPoolTimer<D>::Period() const
    {
        ...
        consume_general<winrt::Windows::System::Threading::IThreadPoolTimer, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::IThreadPoolTimer>::get_Period, put_abi(winrt_impl_result));
        return winrt_impl_result;
    }
    template <typename D> auto consume_Windows_System_Threading_IThreadPoolTimer<D>::Delay() const
    {
        winrt::Windows::Foundation::TimeSpan winrt_impl_result{};
        consume_general<winrt::Windows::System::Threading::IThreadPoolTimer, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::IThreadPoolTimer>::get_Delay, put_abi(winrt_impl_result));
        return winrt_impl_result;
    }
    ...
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::System::Threading::IThreadPoolTimerStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::IThreadPoolTimerStatics>::CreatePeriodicTimer, *(void**)(&handler), impl::bind_in(period), &winrt_impl_result);
        return winrt::Windows::System::Threading::ThreadPoolTimer{ winrt_impl_result, take_ownership_from_abi };
    }
    ...
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::System::Threading::IThreadPoolTimerStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::IThreadPoolTimerStatics>::CreateTimer, *(void**)(&handler), impl::bind_in(delay), &winrt_impl_result);
        return winrt::Windows::System::Threading::ThreadPoolTimer{ winrt_impl_result, take_ownership_from_abi };
    }
    ...
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::System::Threading::IThreadPoolTimerStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::IThreadPoolTimerStatics>::CreatePeriodicTimerWithCompletion, *(void**)(&handler), impl::bind_in(period), *(void**)(&destroyed), &winrt_impl_result);
        return winrt::Windows::System::Threading::ThreadPoolTimer{ winrt_impl_result, take_ownership_from_abi };
    }
    ...
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::System::Threading::IThreadPoolTimerStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::System::Threading::IThreadPoolTimerStatics>::CreateTimerWithCompletion, *(void**)(&handler), impl::bind_in(delay), *(void**)(&destroyed), &winrt_impl_result);
        return winrt::Windows::System::Threading::ThreadPoolTimer{ winrt_impl_result, take_ownership_from_abi };
    }
    ...
    {
        std::int32_t __stdcall RunAsync(void* handler, void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::Foundation::IAsyncAction>(this->shim().RunAsync(*reinterpret_cast<winrt::Windows::System::Threading::WorkItemHandler const*>(&handler)));
            return 0;
        }
        catch (...) { return to_hresult(); }
        std::int32_t __stdcall RunWithPriorityAsync(void* handler, std::int32_t priority, void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::Foundation::IAsyncAction>(this->shim().RunAsync(*reinterpret_cast<winrt::Windows::System::Threading::WorkItemHandler const*>(&handler), *reinterpret_cast<winrt::Windows::System::Threading::WorkItemPriority const*>(&priority)));
            return 0;
        }
        catch (...) { return to_hresult(); }
        std::int32_t __stdcall RunWithPriorityAndOptionsAsync(void* handler, std::int32_t priority, std::uint32_t options, void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
    ...
    {
        std::int32_t __stdcall CreatePeriodicTimer(void* handler, std::int64_t period, void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::System::Threading::ThreadPoolTimer>(this->shim().CreatePeriodicTimer(*reinterpret_cast<winrt::Windows::System::Threading::TimerElapsedHandler const*>(&handler), *reinterpret_cast<winrt::Windows::Foundation::TimeSpan const*>(&period)));
            return 0;
        }
        catch (...) { return to_hresult(); }
        std::int32_t __stdcall CreateTimer(void* handler, std::int64_t delay, void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::System::Threading::ThreadPoolTimer>(this->shim().CreateTimer(*reinterpret_cast<winrt::Windows::System::Threading::TimerElapsedHandler const*>(&handler), *reinterpret_cast<winrt::Windows::Foundation::TimeSpan const*>(&delay)));
            return 0;
        }
        catch (...) { return to_hresult(); }
        std::int32_t __stdcall CreatePeriodicTimerWithCompletion(void* handler, std::int64_t period, void* destroyed, void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::System::Threading::ThreadPoolTimer>(this->shim().CreatePeriodicTimer(*reinterpret_cast<winrt::Windows::System::Threading::TimerElapsedHandler const*>(&handler), *reinterpret_cast<winrt::Windows::Foundation::TimeSpan const*>(&period), *reinterpret_cast<winrt::Windows::System::Threading::TimerDestroyedHandler const*>(&destroyed)));
            return 0;
        }
        catch (...) { return to_hresult(); }
        std::int32_t __stdcall CreateTimerWithCompletion(void* handler, std::int64_t delay, void* destroyed, void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::System::Threading::ThreadPoolTimer>(this->shim().CreateTimer(*reinterpret_cast<winrt::Windows::System::Threading::TimerElapsedHandler const*>(&handler), *reinterpret_cast<winrt::Windows::Foundation::TimeSpan const*>(&delay), *reinterpret_cast<winrt::Windows::System::Threading::TimerDestroyedHandler const*>(&destroyed)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
