...
WINRT_EXPORT namespace winrt::impl
{
    template <typename D> auto consume_Windows_UI_Accessibility_IScreenReaderPositionChangedEventArgs<D>::ScreenPositionInRawPixels() const
    {
        ...
        consume_general<winrt::Windows::UI::Accessibility::IScreenReaderPositionChangedEventArgs, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::Accessibility::IScreenReaderPositionChangedEventArgs>::get_ScreenPositionInRawPixels, put_abi(winrt_impl_result));
    ...
    template <typename D> auto consume_Windows_UI_Accessibility_IScreenReaderPositionChangedEventArgs<D>::IsReadingText() const
    {
        ...
        consume_general<winrt::Windows::UI::Accessibility::IScreenReaderPositionChangedEventArgs, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::Accessibility::IScreenReaderPositionChangedEventArgs>::get_IsReadingText, &winrt_impl_result);
        return winrt_impl_result;
    }
    template <typename D> auto consume_Windows_UI_Accessibility_IScreenReaderService<D>::CurrentScreenReaderPosition() const
    {
        ...
        consume_general<winrt::Windows::UI::Accessibility::IScreenReaderService, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::Accessibility::IScreenReaderService>::get_CurrentScreenReaderPosition, &winrt_impl_result);
        return winrt::Windows::UI::Accessibility::ScreenReaderPositionChangedEventArgs{ winrt_impl_result, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_UI_Accessibility_IScreenReaderService<D>::ScreenReaderPositionChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Accessibility::ScreenReaderService, winrt::Windows::UI::Accessibility::ScreenReaderPositionChangedEventArgs> const& handler) const
    {
        ...
        consume_general<winrt::Windows::UI::Accessibility::IScreenReaderService, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::Accessibility::IScreenReaderService>::add_ScreenReaderPositionChanged, *(void**)(&handler), put_abi(winrt_impl_result));
        return winrt_impl_result;
    }
    ...
    {
        std::int32_t __stdcall get_ScreenPositionInRawPixels(winrt::Windows::Foundation::Rect* winrt_impl_result) noexcept final try
        {
            zero_abi<winrt::Windows::Foundation::Rect>(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::Foundation::Rect>(this->shim().ScreenPositionInRawPixels());
            return 0;
        }
        catch (...) { return to_hresult(); }
        std::int32_t __stdcall get_IsReadingText(bool* winrt_impl_result) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<bool>(this->shim().IsReadingText());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
    ...
    {
        std::int32_t __stdcall get_CurrentScreenReaderPosition(void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::UI::Accessibility::ScreenReaderPositionChangedEventArgs>(this->shim().CurrentScreenReaderPosition());
            return 0;
        }
        catch (...) { return to_hresult(); }
        std::int32_t __stdcall add_ScreenReaderPositionChanged(void* handler, winrt::event_token* winrt_impl_result) noexcept final try
        {
            zero_abi<winrt::event_token>(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::event_token>(this->shim().ScreenReaderPositionChanged(*reinterpret_cast<winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Accessibility::ScreenReaderService, winrt::Windows::UI::Accessibility::ScreenReaderPositionChangedEventArgs> const*>(&handler)));
            return 0;
        }
        catch (...) { return to_hresult(); }
