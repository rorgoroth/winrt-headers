...
WINRT_EXPORT namespace winrt::impl
{
    template <typename D> auto consume_Windows_UI_Composition_Desktop_IDesktopWindowTarget<D>::IsTopmost() const
    {
        ...
        consume_general<winrt::Windows::UI::Composition::Desktop::IDesktopWindowTarget, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::Composition::Desktop::IDesktopWindowTarget>::get_IsTopmost, &winrt_impl_result);
