...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_UI_Composition_Diagnostics_ICompositionDebugSettings<D>::HeatMaps() const
    {
        ...
        consume_general<winrt::Windows::UI::Composition::Diagnostics::ICompositionDebugSettings, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::Composition::Diagnostics::ICompositionDebugSettings>::get_HeatMaps, &winrt_impl_result);
        return winrt::Windows::UI::Composition::Diagnostics::CompositionDebugHeatMaps{ winrt_impl_result, take_ownership_from_abi };
    }
    ...
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::UI::Composition::Diagnostics::ICompositionDebugSettingsStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::Composition::Diagnostics::ICompositionDebugSettingsStatics>::TryGetSettings, *(void**)(&compositor), &winrt_impl_result);
        return winrt::Windows::UI::Composition::Diagnostics::CompositionDebugSettings{ winrt_impl_result, take_ownership_from_abi };
    }
    ...
    {
        std::int32_t __stdcall get_HeatMaps(void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::UI::Composition::Diagnostics::CompositionDebugHeatMaps>(this->shim().HeatMaps());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
    ...
    {
        std::int32_t __stdcall TryGetSettings(void* compositor, void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::UI::Composition::Diagnostics::CompositionDebugSettings>(this->shim().TryGetSettings(*reinterpret_cast<winrt::Windows::UI::Composition::Compositor const*>(&compositor)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
