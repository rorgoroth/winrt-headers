...
WINRT_EXPORT namespace winrt::impl
{
    template <typename D> auto consume_Windows_UI_Input_Preview_IInputActivationListenerPreviewStatics<D>::CreateForApplicationWindow(winrt::Windows::UI::WindowManagement::AppWindow const& window) const
    {
        ...
        consume_general<winrt::Windows::UI::Input::Preview::IInputActivationListenerPreviewStatics, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::Input::Preview::IInputActivationListenerPreviewStatics>::CreateForApplicationWindow, *(void**)(&window), &winrt_impl_result);
        return winrt::Windows::UI::Input::InputActivationListener{ winrt_impl_result, take_ownership_from_abi };
    }
    ...
    {
        std::int32_t __stdcall CreateForApplicationWindow(void* window, void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::UI::Input::InputActivationListener>(this->shim().CreateForApplicationWindow(*reinterpret_cast<winrt::Windows::UI::WindowManagement::AppWindow const*>(&window)));
            return 0;
        }
