...
WINRT_EXPORT namespace winrt::impl
{
    template <typename D> auto consume_Windows_UI_UIAutomation_IAutomationConnection<D>::IsRemoteSystem() const noexcept
    {
        ...
        consume_noexcept<winrt::Windows::UI::UIAutomation::IAutomationConnection, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::UIAutomation::IAutomationConnection>::get_IsRemoteSystem, &winrt_impl_result);
    ...
    template <typename D> auto consume_Windows_UI_UIAutomation_IAutomationConnection<D>::AppUserModelId() const
    {
        ...
        consume_general<winrt::Windows::UI::UIAutomation::IAutomationConnection, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::UIAutomation::IAutomationConnection>::get_AppUserModelId, &winrt_impl_result);
    ...
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::UI::UIAutomation::IAutomationConnection, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::UIAutomation::IAutomationConnection>::get_ExecutableFileName, &winrt_impl_result);
        return hstring{ winrt_impl_result, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_UI_UIAutomation_IAutomationConnectionBoundObject<D>::Connection() const
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::UI::UIAutomation::IAutomationConnectionBoundObject, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::UIAutomation::IAutomationConnectionBoundObject>::get_Connection, &winrt_impl_result);
        return winrt::Windows::UI::UIAutomation::AutomationConnection{ winrt_impl_result, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_UI_UIAutomation_IAutomationElement<D>::IsRemoteSystem() const noexcept
    {
        bool winrt_impl_result{};
        consume_noexcept<winrt::Windows::UI::UIAutomation::IAutomationElement, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::UIAutomation::IAutomationElement>::get_IsRemoteSystem, &winrt_impl_result);
        return winrt_impl_result;
    }
    template <typename D> auto consume_Windows_UI_UIAutomation_IAutomationElement<D>::AppUserModelId() const
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::UI::UIAutomation::IAutomationElement, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::UIAutomation::IAutomationElement>::get_AppUserModelId, &winrt_impl_result);
        return hstring{ winrt_impl_result, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_UI_UIAutomation_IAutomationElement<D>::ExecutableFileName() const
    {
        void* winrt_impl_result{};
        consume_general<winrt::Windows::UI::UIAutomation::IAutomationElement, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::UI::UIAutomation::IAutomationElement>::get_ExecutableFileName, &winrt_impl_result);
        return hstring{ winrt_impl_result, take_ownership_from_abi };
    }
    ...
    {
        std::int32_t __stdcall get_IsRemoteSystem(bool* winrt_impl_result) noexcept final
        {
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<bool>(this->shim().IsRemoteSystem());
            return 0;
        }
    ...
    struct produce<D, winrt::Windows::UI::UIAutomation::IAutomationConnectionBoundObject> : produce_base<D, winrt::Windows::UI::UIAutomation::IAutomationConnectionBoundObject>
    {
        std::int32_t __stdcall get_Connection(void** winrt_impl_result) noexcept final try
        {
            clear_abi(winrt_impl_result);
            typename D::abi_guard guard(this->shim());
            *winrt_impl_result = detach_from<winrt::Windows::UI::UIAutomation::AutomationConnection>(this->shim().Connection());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
