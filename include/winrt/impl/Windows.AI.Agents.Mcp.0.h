...
{
    enum class McpMessageDirection : std::int32_t
    {
        ClientToServer = 0,
        ServerToClient = 1,
    };
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::AI::Agents::Mcp::IMcpMessageFilterExperimental>
    {
        ...
        {
            virtual std::int32_t __stdcall Initialize(void*, std::uint32_t, void*, void*, std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall OnMessage(void*, std::int32_t, void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::AI::Agents::Mcp::IMcpMessageFilterExperimental2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall Initialize(void*, std::uint32_t, void*, std::uint32_t, void*, bool*) noexcept = 0;
            virtual std::int32_t __stdcall OnMessage(void*, std::int32_t, void*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::AI::Agents::Mcp::IMcpMessageFilterResponseExperimental>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IsAllowed(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsAllowed(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_MessageIfNotAllowed(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_MessageIfNotAllowed(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::AI::Agents::Mcp::IMcpMessageFilterResponseExperimental2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall Reject(void*) noexcept = 0;
        };
    };
    template <typename D>
    struct consume_Windows_AI_Agents_Mcp_IMcpMessageFilterExperimental
    {
        auto Initialize(param::hstring const& clientAppUserModelId, std::uint32_t clientProcessId, param::hstring const& serverIdentity, param::hstring const& serverName, std::uint32_t serverProcessId) const;
    ...
    {
        auto Initialize(param::hstring const& clientProcessIdentifier, std::uint32_t clientProcessId, param::hstring const& serverProcessIdentifier, std::uint32_t serverProcessId, param::hstring const& serverId) const;
        auto OnMessage(param::hstring const& message, winrt::Windows::AI::Agents::Mcp::McpMessageDirection const& direction, winrt::Windows::AI::Agents::Mcp::McpMessageFilterResponse const& filterResponse) const;
    };
