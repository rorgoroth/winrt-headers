...
WINRT_EXPORT namespace winrt::impl
{
    ...
    struct consume_Windows_ApplicationModel_Chat_IChatMessageStore
    {
        ...
        auto MessageChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::ApplicationModel::Chat::ChatMessageStore, winrt::Windows::ApplicationModel::Chat::ChatMessageChangedEventArgs> const& handler) const;
        ...
        [[nodiscard]] auto MessageChanged(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::ApplicationModel::Chat::ChatMessageStore, winrt::Windows::ApplicationModel::Chat::ChatMessageChangedEventArgs> const& handler) const;
        auto MessageChanged(winrt::event_token const& token) const noexcept;
    };
