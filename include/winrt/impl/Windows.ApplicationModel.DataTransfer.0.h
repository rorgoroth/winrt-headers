...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::DataTransfer::ITransferTargetDiscoveryOptions>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_DataPackage(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_MaxAppTargets(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_MaxAppTargets(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_AllowedTargetAppIds(std::uint32_t* __winrt_impl_resultSize, void***) noexcept = 0;
            virtual std::int32_t __stdcall put_AllowedTargetAppIds(std::uint32_t, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::DataTransfer::ITransferTargetStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateWatcher(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::DataTransfer::ITransferTargetWatcher>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall TransferToAsync(void*, struct struct_Windows_UI_WindowId, void**) noexcept = 0;
    ...
    struct consume_Windows_ApplicationModel_DataTransfer_ITransferTargetDiscoveryOptions
    {
        ...
        auto MaxAppTargets(std::int32_t value) const;
