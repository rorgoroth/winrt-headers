...
{
    enum class StartupAppImpactPreview : std::int32_t
    {
        Unknown = 0,
        None = 1,
        Low = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::ApplicationModel::Preview::IStartupAppInfoPreview>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_Impact(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ExecutablePath(void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::ApplicationModel::Preview::IStartupAppsManagerPreview>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetStartupAppInfos(void**) noexcept = 0;
        };
    };
