...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattServiceProvider2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall UpdateAdvertisingParameters(void*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::IGattServiceProviderAdvertisingParameters3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_UseLowEnergyUncoded1MPhyAsSecondaryPhy(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_UseLowEnergyUncoded1MPhyAsSecondaryPhy(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_UseLowEnergyUncoded2MPhyAsSecondaryPhy(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_UseLowEnergyUncoded2MPhyAsSecondaryPhy(bool) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_Devices_Bluetooth_GenericAttributeProfile_IGattCharacteristic
    {
        ...
        auto ValueChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::GattCharacteristic, winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::GattValueChangedEventArgs> const& handler) const;
        ...
        [[nodiscard]] auto ValueChanged(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::GattCharacteristic, winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::GattValueChangedEventArgs> const& handler) const;
