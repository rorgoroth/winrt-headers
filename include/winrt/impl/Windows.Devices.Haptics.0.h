...
{
    enum class HapticDeviceType : std::int32_t
    {
        None = 0,
        Generic = 1,
        Pen = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct category<winrt::Windows::Devices::Haptics::HapticsControllerOverrideToken>{ using type = struct_category<std::int64_t>; };
    ...
    template <> struct abi<winrt::Windows::Devices::Haptics::IInputHapticsManager>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_CurrentHapticsControllerDeviceType(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_CurrentHapticsController(void**) noexcept = 0;
            virtual std::int32_t __stdcall TrySendHapticWaveform(std::uint16_t, std::uint16_t, bool*) noexcept = 0;
            virtual std::int32_t __stdcall TrySendHapticWaveformWithIntensity(std::uint16_t, std::uint16_t, double, bool*) noexcept = 0;
            virtual std::int32_t __stdcall TrySendHapticWaveformForDuration(std::uint16_t, std::uint16_t, double, std::int64_t, bool*) noexcept = 0;
            virtual std::int32_t __stdcall TrySendHapticWaveformForPlayCount(std::uint16_t, std::uint16_t, double, std::int32_t, std::int64_t, bool*) noexcept = 0;
            virtual std::int32_t __stdcall TryStopFeedback(bool*) noexcept = 0;
            virtual std::int32_t __stdcall SetOverrideHapticsController(std::int32_t, void*, struct struct_Windows_Devices_Haptics_HapticsControllerOverrideToken*) noexcept = 0;
            virtual std::int32_t __stdcall ClearOverrideHapticsController(struct struct_Windows_Devices_Haptics_HapticsControllerOverrideToken) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Haptics::IInputHapticsManagerStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall IsHapticDevicePresent(bool*) noexcept = 0;
            virtual std::int32_t __stdcall GetForCurrentThread(void**) noexcept = 0;
            virtual std::int32_t __stdcall TryGetForThread(std::uint32_t, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Devices::Haptics::IKnownSimpleHapticsControllerWaveformsStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_BrushContinuous(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_ChiselMarkerContinuous(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_EraserContinuous(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Error(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_GalaxyPenContinuous(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Hover(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_InkContinuous(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_MarkerContinuous(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_PencilContinuous(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Success(std::uint16_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Devices::Haptics::IKnownSimpleHapticsControllerWaveformsStatics3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Collide(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Align(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Step(std::uint16_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_Grow(std::uint16_t*) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_Devices_Haptics_IInputHapticsManager
    {
        ...
        auto TrySendHapticWaveform(std::uint16_t waveform, std::uint16_t waveformFallback) const;
        auto TrySendHapticWaveform(std::uint16_t waveform, std::uint16_t waveformFallback, double intensity) const;
        auto TrySendHapticWaveformForDuration(std::uint16_t waveform, std::uint16_t waveformFallback, double intensity, winrt::Windows::Foundation::TimeSpan const& playDuration) const;
        auto TrySendHapticWaveformForPlayCount(std::uint16_t waveform, std::uint16_t waveformFallback, double intensity, std::int32_t playCount, winrt::Windows::Foundation::TimeSpan const& replayPauseInterval) const;
    ...
    struct consume_Windows_Devices_Haptics_IInputHapticsManagerStatics
    {
        ...
        auto TryGetForThread(std::uint32_t ThreadId) const;
    };
