...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Devices::Lights::ILampArray>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall GetIndicesForKey(std::int32_t, std::uint32_t* __winrt_impl_resultSize, std::int32_t**) noexcept = 0;
            virtual std::int32_t __stdcall GetIndicesForPurposes(std::uint32_t, std::uint32_t* __winrt_impl_resultSize, std::int32_t**) noexcept = 0;
