...
WINRT_EXPORT namespace winrt::Windows::Devices::WiFi
{
    ...
    enum class WiFiOnDemandHotspotAvailability : std::int32_t
    {
        Available = 0,
        Unavailable = 1,
    };
    enum class WiFiOnDemandHotspotCellularBars : std::int32_t
    {
        ZeroBars = 0,
        OneBar = 1,
        TwoBars = 2,
    ...
    enum class WiFiOnDemandHotspotConnectStatus : std::int32_t
    {
        UnspecifiedFailure = 0,
        Success = 1,
        AppTimedOut = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Devices::WiFi::IWiFiOnDemandHotspotConnectTriggerDetails>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_RequestedNetwork(void**) noexcept = 0;
            virtual std::int32_t __stdcall ReportError(std::int32_t) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Devices::WiFi::IWiFiOnDemandHotspotNetwork>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetProperties(void**) noexcept = 0;
            virtual std::int32_t __stdcall UpdateProperties(void*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Devices::WiFi::IWiFiOnDemandHotspotNetworkProperties>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall put_Availability(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_RemainingBatteryPercent(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_RemainingBatteryPercent(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_CellularBars(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_CellularBars(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsMetered(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsMetered(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_Ssid(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Devices::WiFi::IWiFiOnDemandHotspotNetworkStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetOrCreateById(winrt::guid, void**) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_Devices_WiFi_IWiFiAdapter
    {
        ...
        auto AvailableNetworksChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Devices::WiFi::WiFiAdapter, winrt::Windows::Foundation::IInspectable> const& handler) const;
        ...
        [[nodiscard]] auto AvailableNetworksChanged(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Devices::WiFi::WiFiAdapter, winrt::Windows::Foundation::IInspectable> const& handler) const;
        auto AvailableNetworksChanged(winrt::event_token const& token) const noexcept;
    ...
    struct consume_Windows_Devices_WiFi_IWiFiOnDemandHotspotNetworkProperties
    {
        ...
        auto RemainingBatteryPercent(winrt::Windows::Foundation::IReference<std::uint32_t> const& value) const;
