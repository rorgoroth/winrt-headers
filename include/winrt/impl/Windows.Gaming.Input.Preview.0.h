...
{
    enum class DeviceCommand : std::int32_t
    {
        Reset = 0,
    };
    enum class GameControllerBatteryChargingState : std::int32_t
    {
        Unknown = 0,
        Inactive = 1,
        Active = 2,
    ...
    enum class GameControllerBatteryKind : std::int32_t
    {
        Unknown = 0,
        None = 1,
        Standard = 2,
    ...
    enum class GameControllerBatteryLevel : std::int32_t
    {
        Unknown = 0,
        Critical = 1,
        Low = 2,
    ...
    enum class GameControllerFirmwareCorruptReason : std::int32_t
    {
        Unknown = 0,
        NotCorrupt = 1,
        TwoUpCorrupt = 2,
    ...
    enum class HeadsetLevel : std::int32_t
    {
        Off = 0,
        Low = 1,
        Medium = 2,
    ...
    enum class HeadsetOperation : std::int32_t
    {
        Geq = 0,
        BassBoostGain = 1,
        SmartMute = 2,
    ...
    enum class RemappingButtonCategory : std::int32_t
    {
        ButtonSettings = 0,
        AnalogSettings = 1,
        VibrationSettings = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct category<winrt::Windows::Gaming::Input::Preview::HeadsetGeqGains>{ using type = struct_category<std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t>; };
    ...
    template <> struct abi<winrt::Windows::Gaming::Input::Preview::ILegacyGipGameControllerProvider>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_BatteryChargingState(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_BatteryKind(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_BatteryLevel(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetDeviceFirmwareCorruptionState(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsFirmwareCorrupted(bool*) noexcept = 0;
            virtual std::int32_t __stdcall IsInterfaceSupported(winrt::guid, bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_IsSyntheticDevice(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_PreferredTypes(void**) noexcept = 0;
            virtual std::int32_t __stdcall ExecuteCommand(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall SetHomeLedIntensity(std::uint8_t) noexcept = 0;
            virtual std::int32_t __stdcall GetExtendedDeviceInfo(std::uint32_t* __winrt_impl_resultSize, std::uint8_t**) noexcept = 0;
            virtual std::int32_t __stdcall SetHeadsetOperation(std::int32_t, std::uint32_t, std::uint8_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetHeadsetOperation(std::int32_t, std::uint32_t* __winrt_impl_resultSize, std::uint8_t**) noexcept = 0;
            virtual std::int32_t __stdcall get_AppCompatVersion(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall SetStandardControllerButtonRemapping(void*, bool, void*) noexcept = 0;
            virtual std::int32_t __stdcall GetStandardControllerButtonRemapping(void*, bool, void**) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Gaming::Input::Preview::ILegacyGipGameControllerProviderStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall FromGameControllerProvider(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall PairPilotToCopilot(void*, void*, void*) noexcept = 0;
            virtual std::int32_t __stdcall ClearPairing(void*, void*) noexcept = 0;
            virtual std::int32_t __stdcall IsPilot(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall IsCopilot(void*, void*, void**) noexcept = 0;
        };
    };
    template <typename D>
    ...
    struct consume_Windows_Gaming_Input_Preview_ILegacyGipGameControllerProvider
    {
        ...
        auto SetHomeLedIntensity(std::uint8_t intensity) const;
        auto GetExtendedDeviceInfo() const;
        auto SetHeadsetOperation(winrt::Windows::Gaming::Input::Preview::HeadsetOperation const& operation, array_view<std::uint8_t const> buffer) const;
    ...
    {
        std::int32_t band1Gain;
        std::int32_t band2Gain;
        std::int32_t band3Gain;
        std::int32_t band4Gain;
        std::int32_t band5Gain;
    };
