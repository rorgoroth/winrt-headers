...
{
    enum class GraphicsCaptureAccessKind : std::int32_t
    {
        Borderless = 0,
        Programmatic = 1,
    };
    enum class GraphicsCaptureDirtyRegionMode : std::int32_t
    {
        ReportOnly = 0,
        ReportAndRender = 1,
    };
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Graphics::Capture::IDirect3D11CaptureFrame2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_DirtyRegions(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_DirtyRegionMode(std::int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Graphics::Capture::IDirect3D11CaptureFrame3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_ConfigurationIteration(std::uint64_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Graphics::Capture::IDisplayGraphicsCaptureSession>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall SetWindowExclusionList(void*, std::uint64_t*) noexcept = 0;
            virtual std::int32_t __stdcall GetWindowExclusionList(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Graphics::Capture::IGraphicsCaptureItemStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall TryCreateFromWindowId(struct struct_Windows_UI_WindowId, void**) noexcept = 0;
            virtual std::int32_t __stdcall TryCreateFromDisplayId(struct struct_Windows_Graphics_DisplayId, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Graphics::Capture::IGraphicsCaptureSession3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IsBorderRequired(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsBorderRequired(bool) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Graphics::Capture::IGraphicsCaptureSession4>
    {
        ...
        {
            virtual std::int32_t __stdcall get_DirtyRegionMode(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_DirtyRegionMode(std::int32_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Graphics::Capture::IGraphicsCaptureSession5>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall put_MinUpdateInterval(std::int64_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Graphics::Capture::IGraphicsCaptureSession6>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IncludeSecondaryWindows(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IncludeSecondaryWindows(bool) noexcept = 0;
        };
    };
