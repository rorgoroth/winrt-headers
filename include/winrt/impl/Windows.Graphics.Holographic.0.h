...
{
    enum class HolographicDepthReprojectionMethod : std::int32_t
    {
        DepthReprojection = 0,
        AutoPlanar = 1,
    };
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Graphics::Holographic::IHolographicCameraRenderingParameters4>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_DepthReprojectionMethod(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_DepthReprojectionMethod(std::int32_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::Graphics::Holographic::IHolographicCameraViewportParameters>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_HiddenAreaMesh(std::uint32_t* __winrt_impl_resultSize, winrt::Windows::Foundation::Numerics::float2**) noexcept = 0;
            virtual std::int32_t __stdcall get_VisibleAreaMesh(std::uint32_t* __winrt_impl_resultSize, winrt::Windows::Foundation::Numerics::float2**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Graphics::Holographic::IHolographicViewConfiguration2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_SupportedDepthReprojectionMethods(void**) noexcept = 0;
        };
    };
    template <typename D>
    ...
    struct consume_Windows_Graphics_Holographic_IHolographicSpace
    {
        ...
        auto CameraAdded(winrt::event_token const& token) const noexcept;
        ...
        auto CameraRemoved(winrt::event_token const& token) const noexcept;
