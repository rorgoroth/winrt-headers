...
WINRT_EXPORT namespace winrt::Windows::Management::Update
{
    ...
    struct WINRT_IMPL_EMPTY_BASES WindowsSoftwareUpdateLocalizationInfo : winrt::Windows::Management::Update::IWindowsSoftwareUpdateLocalizationInfo
    {
        ...
        WindowsSoftwareUpdateLocalizationInfo(std::uint32_t languageId, param::hstring const& title, param::hstring const& description, winrt::Windows::Foundation::Uri const& moreInfoUrl);
    };
    ...
    struct WINRT_IMPL_EMPTY_BASES WindowsSoftwareUpdateOptionalInfo : winrt::Windows::Management::Update::IWindowsSoftwareUpdateOptionalInfo
    {
        ...
        WindowsSoftwareUpdateOptionalInfo(winrt::Windows::Foundation::IReference<std::int32_t> const& complianceDeadlineInDays, winrt::Windows::Foundation::IReference<std::int32_t> const& complianceGracePeriodInDays);
        WindowsSoftwareUpdateOptionalInfo(param::iterable<winrt::Windows::Management::Update::WindowsSoftwareUpdateLocalizationInfo> const& localizationInfo, winrt::Windows::Foundation::IReference<std::int32_t> const& complianceDeadlineInDays, winrt::Windows::Foundation::IReference<std::int32_t> const& complianceGracePeriodInDays);
    };
    ...
    struct WINRT_IMPL_EMPTY_BASES WindowsSoftwareUpdateProviderActionResult : winrt::Windows::Management::Update::IWindowsSoftwareUpdateProviderActionResult
    {
        ...
        WindowsSoftwareUpdateProviderActionResult(winrt::Windows::Management::Update::WindowsSoftwareUpdateActionResult const& actionResult, winrt::Windows::Management::Update::WindowsSoftwareUpdateRestartReason const& restartReason, std::uint32_t resultCode, std::uint64_t extendedError);
    };
    ...
    struct WINRT_IMPL_EMPTY_BASES WindowsSoftwareUpdateResult : winrt::Windows::Management::Update::IWindowsSoftwareUpdateResult
    {
        ...
        WindowsSoftwareUpdateResult(bool succeeded, std::uint32_t resultCode);
        WindowsSoftwareUpdateResult(bool succeeded, std::uint32_t resultCode, std::uint64_t extendedError);
        WindowsSoftwareUpdateResult(bool succeeded, bool cancelRequested, std::uint32_t resultCode, std::uint64_t extendedError);
    };
    struct WINRT_IMPL_EMPTY_BASES WindowsSoftwareUpdateScanResult : winrt::Windows::Management::Update::IWindowsSoftwareUpdateScanResult
    {
        ...
        WindowsSoftwareUpdateScanResult(bool succeeded, std::uint32_t resultCode, param::iterable<winrt::Windows::Management::Update::WindowsSoftwareUpdate> const& updates);
        WindowsSoftwareUpdateScanResult(bool succeeded, std::uint32_t resultCode, std::uint64_t extendedError, param::iterable<winrt::Windows::Management::Update::WindowsSoftwareUpdate> const& updates);
    };
    struct WINRT_IMPL_EMPTY_BASES WindowsSoftwareUpdateVersion : winrt::Windows::Management::Update::IWindowsSoftwareUpdateVersion
    {
        ...
        WindowsSoftwareUpdateVersion(std::uint32_t major, std::uint32_t minor, std::uint32_t revisionMajor, std::uint32_t revisionMinor);
    };
    ...
    struct WINRT_IMPL_EMPTY_BASES WindowsUpdateRestartRequestOptions : winrt::Windows::Management::Update::IWindowsUpdateRestartRequestOptions
    {
        ...
        WindowsUpdateRestartRequestOptions(param::hstring const& title, param::hstring const& description, winrt::Windows::Foundation::Uri const& moreInfoUrl, std::int32_t complianceDeadlineInDays, std::int32_t complianceGracePeriodInDays);
    };
