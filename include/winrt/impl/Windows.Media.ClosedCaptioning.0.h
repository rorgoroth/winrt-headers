...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Media::ClosedCaptioning::IClosedCaptionThemeStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetAvailableThemes(std::uint32_t* __winrt_impl_resultSize, void***) noexcept = 0;
            virtual std::int32_t __stdcall GetSelectedTheme(void**) noexcept = 0;
            virtual std::int32_t __stdcall TrySetSelectedTheme(void*, bool*) noexcept = 0;
            virtual std::int32_t __stdcall add_ThemesChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_ThemesChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_SelectedThemeChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_SelectedThemeChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <typename D>
