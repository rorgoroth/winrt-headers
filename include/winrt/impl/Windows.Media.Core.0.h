...
WINRT_EXPORT namespace winrt::Windows::Media::Core
{
    ...
    enum class TimedTextBoutenPosition : std::int32_t
    {
        Before = 0,
        After = 1,
        Outside = 2,
    };
    enum class TimedTextBoutenType : std::int32_t
    {
        None = 0,
        Auto = 1,
        FilledCircle = 2,
    ...
    enum class TimedTextRubyAlign : std::int32_t
    {
        Center = 0,
        Start = 1,
        End = 2,
    ...
    enum class TimedTextRubyPosition : std::int32_t
    {
        Before = 0,
        After = 1,
        Outside = 2,
    };
    enum class TimedTextRubyReserve : std::int32_t
    {
        None = 0,
        Before = 1,
        After = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Media::Core::ICodecSubtypesStatics2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_VideoFormatAv1(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Core::ITimedTextBouten>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_Position(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Position(std::int32_t) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Core::ITimedTextRuby>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_Position(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Position(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Align(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Align(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall get_Reserve(std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_Reserve(std::int32_t) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Media::Core::ITimedTextStyle3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Ruby(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Bouten(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_IsTextCombined(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsTextCombined(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_FontAngleInDegrees(double*) noexcept = 0;
            virtual std::int32_t __stdcall put_FontAngleInDegrees(double) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_Media_Core_IFaceDetectionEffect
    {
        ...
        auto FaceDetected(winrt::event_token const& token) const noexcept;
    };
    ...
    struct consume_Windows_Media_Core_ISceneAnalysisEffect
    {
        ...
        auto SceneAnalyzed(winrt::event_token const& token) const noexcept;
    };
    ...
    struct consume_Windows_Media_Core_IVideoStabilizationEffect
    {
        ...
        auto EnabledChanged(winrt::event_token const& token) const noexcept;
