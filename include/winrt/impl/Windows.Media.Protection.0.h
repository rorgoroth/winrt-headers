...
WINRT_EXPORT namespace winrt::impl
{
    ...
    struct consume_Windows_Media_Protection_IMediaProtectionManager
    {
        ...
        auto ServiceRequested(winrt::event_token const& token) const noexcept;
        ...
        auto RebootNeeded(winrt::event_token const& token) const noexcept;
        ...
        auto ComponentLoadFailed(winrt::event_token const& token) const noexcept;
