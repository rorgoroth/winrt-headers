...
WINRT_EXPORT namespace winrt::impl
{
    ...
    struct consume_Windows_Networking_BackgroundTransfer_IDownloadOperation3
    {
        ...
        auto RangesDownloaded(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Networking::BackgroundTransfer::DownloadOperation, winrt::Windows::Networking::BackgroundTransfer::BackgroundTransferRangesDownloadedEventArgs> const& handler) const;
        ...
        [[nodiscard]] auto RangesDownloaded(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Networking::BackgroundTransfer::DownloadOperation, winrt::Windows::Networking::BackgroundTransfer::BackgroundTransferRangesDownloadedEventArgs> const& handler) const;
        auto RangesDownloaded(winrt::event_token const& token) const noexcept;
