...
WINRT_EXPORT namespace winrt::Windows::Networking::Connectivity
{
    ...
    enum class DomainAuthenticationKind : std::int32_t
    {
        None = 0,
        Ldap = 1,
        Tls = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Networking::Connectivity::IConnectionProfile6>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall IsDomainAuthenticatedBy(std::int32_t, bool*) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_Networking_Connectivity_INetworkInformationStatics
    {
        ...
        auto NetworkStatusChanged(winrt::Windows::Networking::Connectivity::NetworkStatusChangedEventHandler const& handler) const;
        ...
        [[nodiscard]] auto NetworkStatusChanged(auto_revoke_t, winrt::Windows::Networking::Connectivity::NetworkStatusChangedEventHandler const& handler) const;
        auto NetworkStatusChanged(winrt::event_token const& token) const noexcept;
    };
