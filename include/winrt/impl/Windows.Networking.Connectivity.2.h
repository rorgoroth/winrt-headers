...
WINRT_EXPORT namespace winrt::Windows::Networking::Connectivity
{
    ...
    struct NetworkInformation
    {
        ...
        static auto NetworkStatusChanged(winrt::Windows::Networking::Connectivity::NetworkStatusChangedEventHandler const& handler);
        ...
        [[nodiscard]] static auto NetworkStatusChanged(auto_revoke_t, winrt::Windows::Networking::Connectivity::NetworkStatusChangedEventHandler const& handler);
        static auto NetworkStatusChanged(winrt::event_token const& token);
