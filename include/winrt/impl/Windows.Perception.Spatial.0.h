...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Perception::Spatial::ISpatialStageFrameOfReference>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall TryGetMovementBounds(void*, std::uint32_t* __winrt_impl_resultSize, winrt::Windows::Foundation::Numerics::float3**) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_Perception_Spatial_ISpatialAnchor
    {
        ...
        auto RawCoordinateSystemAdjusted(winrt::event_token const& token) const noexcept;
    };
    ...
    struct consume_Windows_Perception_Spatial_ISpatialLocator
    {
        ...
        auto LocatabilityChanged(winrt::event_token const& token) const noexcept;
        ...
        auto PositionalTrackingDeactivating(winrt::event_token const& token) const noexcept;
