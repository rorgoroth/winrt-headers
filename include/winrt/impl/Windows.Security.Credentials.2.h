...
WINRT_EXPORT namespace winrt::Windows::Security::Credentials
{
    ...
    struct WINRT_IMPL_EMPTY_BASES KeyCredentialCacheConfiguration : winrt::Windows::Security::Credentials::IKeyCredentialCacheConfiguration
    {
        ...
        KeyCredentialCacheConfiguration(winrt::Windows::Security::Credentials::KeyCredentialCacheOption const& cacheOption, winrt::Windows::Foundation::TimeSpan const& timeout, std::uint32_t usageCount);
    };
