...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Security::Cryptography::Certificates::ICertificate>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_SerialNumber(std::uint32_t* __winrt_impl_resultSize, std::uint8_t**) noexcept = 0;
            virtual std::int32_t __stdcall GetHashValue(std::uint32_t* __winrt_impl_resultSize, std::uint8_t**) noexcept = 0;
            virtual std::int32_t __stdcall GetHashValueWithAlgorithm(void*, std::uint32_t* __winrt_impl_resultSize, std::uint8_t**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Security::Cryptography::Certificates::ICertificateExtension>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_Value(std::uint32_t* __winrt_impl_resultSize, std::uint8_t**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Security::Cryptography::Certificates::ICertificateQuery>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_FriendlyName(void**) noexcept = 0;
            virtual std::int32_t __stdcall put_FriendlyName(void*) noexcept = 0;
            virtual std::int32_t __stdcall get_Thumbprint(std::uint32_t* __winrt_impl_resultSize, std::uint8_t**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Security::Cryptography::Certificates::ICertificateRequestProperties3>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_CurveParameters(std::uint32_t* __winrt_impl_resultSize, std::uint8_t**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Security::Cryptography::Certificates::ICmsAttachedSignature>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_Content(std::uint32_t* __winrt_impl_resultSize, std::uint8_t**) noexcept = 0;
