...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Storage::IStorageLibraryChangeReader2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetLastChangeId(std::uint64_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Storage::IStorageLibraryChangeTracker2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall EnableWithOptions(void*) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::Storage::IStorageLibraryChangeTrackerOptions>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_TrackChangeDetails(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_TrackChangeDetails(bool) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Storage::IStorageLibraryLastChangeIdStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_Unknown(std::uint64_t*) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_Storage_IStorageLibrary
    {
        ...
        auto DefinitionChanged(winrt::event_token const& token) const noexcept;
    };
