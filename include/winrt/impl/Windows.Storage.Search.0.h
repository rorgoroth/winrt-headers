...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::Storage::Search::IQueryOptionsAdditionalSearchSources>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IncludeLocalSemanticIndex(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IncludeLocalSemanticIndex(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_IncludeCloudProviders(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IncludeCloudProviders(bool) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_Storage_Search_IStorageQueryResultBase
    {
        ...
        auto ContentsChanged(winrt::event_token const& token) const noexcept;
        auto OptionsChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Storage::Search::IStorageQueryResultBase, winrt::Windows::Foundation::IInspectable> const& handler) const;
        ...
        [[nodiscard]] auto OptionsChanged(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Storage::Search::IStorageQueryResultBase, winrt::Windows::Foundation::IInspectable> const& handler) const;
        auto OptionsChanged(winrt::event_token const& token) const noexcept;
