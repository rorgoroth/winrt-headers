...
WINRT_EXPORT namespace winrt::Windows::UI::Core
{
    ...
    enum class CoreIndependentInputFilters : std::uint32_t
    {
        None = 0,
        MouseButton = 0x1,
        MouseWheel = 0x2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::UI::Core::ICoreIndependentInputSourceController>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IsTransparentForUncontrolledInput(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsTransparentForUncontrolledInput(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_IsPalmRejectionEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsPalmRejectionEnabled(bool) noexcept = 0;
            virtual std::int32_t __stdcall get_Source(void**) noexcept = 0;
            virtual std::int32_t __stdcall SetControlledInput(std::uint32_t) noexcept = 0;
            virtual std::int32_t __stdcall SetControlledInputWithFilters(std::uint32_t, std::uint32_t, std::uint32_t) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Core::ICoreIndependentInputSourceControllerStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateForVisual(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateForIVisualElement(void*, void**) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_UI_Core_ICoreAcceleratorKeys
    {
        ...
        auto AcceleratorKeyActivated(winrt::event_token const& token) const noexcept;
    };
    ...
    struct consume_Windows_UI_Core_ICoreClosestInteractiveBoundsRequested
    {
        ...
        auto ClosestInteractiveBoundsRequested(winrt::event_token const& token) const noexcept;
    };
    ...
    struct consume_Windows_UI_Core_ICoreInputSourceBase
    {
        ...
        auto InputEnabled(winrt::event_token const& token) const noexcept;
    };
    ...
    struct consume_Windows_UI_Core_ICoreWindow4
    {
        ...
        auto ResizeStarted(winrt::event_token const& token) const noexcept;
        ...
        auto ResizeCompleted(winrt::event_token const& token) const noexcept;
    };
