...
WINRT_EXPORT namespace winrt::Windows::UI::Input
{
    ...
    enum class TouchpadGlobalAction : std::int32_t
    {
        ThreeFingerTap = 0,
        FourFingerTap = 1,
        FiveFingerTap = 2,
    ...
    enum class TouchpadGlobalGestureKinds : std::uint32_t
    {
        None = 0,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::UI::Input::IPointerPointPhysicalPosition>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IsPhysicalPositionSupported(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_PhysicalPosition(winrt::Windows::Foundation::Point*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::UI::Input::ITouchpadGesturesController>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_SupportedGestures(std::uint32_t*) noexcept = 0;
            virtual std::int32_t __stdcall put_SupportedGestures(std::uint32_t) noexcept = 0;
            ...
            virtual std::int32_t __stdcall add_GlobalActionPerformed(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_GlobalActionPerformed(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Input::ITouchpadGesturesControllerStatics>
    {
        ...
        {
            virtual std::int32_t __stdcall IsSupported(bool*) noexcept = 0;
            virtual std::int32_t __stdcall CreateForProcess(void**) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_UI_Input_IRadialController
    {
        ...
        auto ScreenContactStarted(winrt::event_token const& token) const noexcept;
        ...
        auto ScreenContactEnded(winrt::event_token const& token) const noexcept;
        ...
        auto ScreenContactContinued(winrt::event_token const& token) const noexcept;
        ...
        auto ControlAcquired(winrt::event_token const& token) const noexcept;
    };
