...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::UI::Input::Inking::IInkInputConfiguration2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall get_IsPenHapticFeedbackEnabled(bool*) noexcept = 0;
            virtual std::int32_t __stdcall put_IsPenHapticFeedbackEnabled(bool) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::UI::Input::Inking::IPenAndInkSettings2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall SetPenHandedness(std::int32_t) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_UI_Input_Inking_IInkPresenter
    {
        ...
        auto StrokesCollected(winrt::event_token const& token) const noexcept;
        ...
        auto StrokesErased(winrt::event_token const& token) const noexcept;
    };
    ...
    struct consume_Windows_UI_Input_Inking_IInkStrokeInput
    {
        ...
        auto StrokeStarted(winrt::event_token const& token) const noexcept;
        ...
        auto StrokeContinued(winrt::event_token const& token) const noexcept;
        ...
        auto StrokeEnded(winrt::event_token const& token) const noexcept;
        ...
        auto StrokeCanceled(winrt::event_token const& token) const noexcept;
    ...
    struct consume_Windows_UI_Input_Inking_IInkUnprocessedInput
    {
        ...
        auto PointerHovered(winrt::event_token const& token) const noexcept;
