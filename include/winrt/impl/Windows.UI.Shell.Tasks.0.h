...
{
    enum class AppTaskState : std::int32_t
    {
        Running = 0,
        Completed = 1,
        NeedsAttention = 2,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::UI::Shell::Tasks::IAppTaskContent>
    {
        ...
        {
            virtual std::int32_t __stdcall AddButton(void*, void*) noexcept = 0;
            virtual std::int32_t __stdcall SetTextInput(void*, void*) noexcept = 0;
            virtual std::int32_t __stdcall SetQuestion(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Shell::Tasks::IAppTaskContentStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall CreateSequenceOfSteps(std::uint32_t, void**, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreatePreviewThumbnail(void*, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateTextSummaryResult(void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateGeneratedAssetsResult(std::uint32_t, void**, void**) noexcept = 0;
            virtual std::int32_t __stdcall get_MaxButtons(std::uint32_t*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Shell::Tasks::IAppTaskInfo>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall Remove() noexcept = 0;
            virtual std::int32_t __stdcall Update(std::int32_t, void*) noexcept = 0;
            virtual std::int32_t __stdcall UpdateState(std::int32_t) noexcept = 0;
            virtual std::int32_t __stdcall UpdateTitles(void*, void*) noexcept = 0;
            virtual std::int32_t __stdcall GetCompletedSteps(std::uint32_t* __winrt_impl_resultSize, void***) noexcept = 0;
            virtual std::int32_t __stdcall GetExecutingStep(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Title(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_Subtitle(void**) noexcept = 0;
            virtual std::int32_t __stdcall get_DeepLink(void**) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::UI::Shell::Tasks::IAppTaskInfo2>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_HiddenByUser(bool*) noexcept = 0;
            virtual std::int32_t __stdcall UpdateDeepLink(void*) noexcept = 0;
        };
    };
    template <> struct abi<winrt::Windows::UI::Shell::Tasks::IAppTaskInfoStatics>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall FindAll(std::uint32_t* __winrt_impl_resultSize, void***) noexcept = 0;
