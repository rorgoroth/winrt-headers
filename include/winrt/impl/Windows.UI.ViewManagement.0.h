...
WINRT_EXPORT namespace winrt::Windows::UI::ViewManagement
{
    ...
    enum class ScreenCaptureDisabledBehavior : std::int32_t
    {
        DrawAsBlack = 0,
...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::UI::ViewManagement::IUIViewSettingsPreferredInteractionMode>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetPreferredInteractionMode(std::uint32_t, std::int32_t*, std::int32_t*) noexcept = 0;
            virtual std::int32_t __stdcall add_PreferredInteractionModeChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_PreferredInteractionModeChanged(winrt::event_token) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_UI_ViewManagement_IAccessibilitySettings
    {
        ...
        auto HighContrastChanged(winrt::event_token const& token) const noexcept;
    };
    ...
    struct consume_Windows_UI_ViewManagement_IUISettings2
    {
        ...
        auto TextScaleFactorChanged(winrt::event_token const& token) const noexcept;
    };
    ...
    struct consume_Windows_UI_ViewManagement_IUISettings3
    {
        ...
        auto ColorValuesChanged(winrt::event_token const& token) const noexcept;
    };
    ...
    struct consume_Windows_UI_ViewManagement_IUISettings4
    {
        ...
        auto AdvancedEffectsEnabledChanged(winrt::event_token const& token) const noexcept;
    };
