...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::UI::ViewManagement::Core::ICoreFrameworkInputView>
    {
        ...
        {
            virtual std::int32_t __stdcall add_PrimaryViewAnimationStarting(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_PrimaryViewAnimationStarting(winrt::event_token) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::UI::ViewManagement::Core::ICoreFrameworkInputViewAnimationStartingEventArgs>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall get_FrameworkAnimationRecommended(bool*) noexcept = 0;
            virtual std::int32_t __stdcall get_AnimationDuration(std::int64_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::UI::ViewManagement::Core::ICoreInputView5>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall IsKindSupported(std::int32_t, bool*) noexcept = 0;
            virtual std::int32_t __stdcall add_SupportedKindsChanged(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_SupportedKindsChanged(winrt::event_token) noexcept = 0;
            virtual std::int32_t __stdcall add_PrimaryViewAnimationStarting(void*, winrt::event_token*) noexcept = 0;
            virtual std::int32_t __stdcall remove_PrimaryViewAnimationStarting(winrt::event_token) noexcept = 0;
        };
    };
